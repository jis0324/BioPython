...
# mcoffee running command.
mcoffee = "t_coffee"

infile = input("Please input the full path of input sequence : ")
#This line prepares the command to be used in mcoffee application. 
mcoffee_cline = TCoffeeCommandline(mcoffee, mode="mcoffee", infile=infile, outfile="output.fasta")

#This line is to save the starting time of mcoffee 
timeStarted = time.time() 

#This line runs the command to perform the alignment process
child = subprocess.Popen(str(mcoffee_cline), shell=True, universal_newlines=True)
