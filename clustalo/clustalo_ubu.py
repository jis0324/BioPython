...
#This line prepares the command to be used in clustalo application. 
clustalo_cline = ClustalOmegaCommandline(infile=os.path.join(base_dir, "input.fasta"), outfile=os.path.join(base_dir, "output.fasta"), verbose=True, auto=True)
